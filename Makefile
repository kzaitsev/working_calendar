...
GOOGLE_OAUTH_CLIENT_JSON ?= $(HOME)/Downloads/client_secret_728926875401-u5ou0oi0d0bklrd3qbl328nv58j8jj4t.apps.googleusercontent.com.json
OAUTH_GENERATED_SOURCE := Sources/WorkingCalendar/GeneratedOAuthClientConfiguration.swift
SOURCES := $(shell find Sources/WorkingCalendar -name '*.swift' ! -name 'GeneratedOAuthClientConfiguration.swift' | sort) $(OAUTH_GENERATED_SOURCE)
...
CALDAV_VERIFY_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Sources/WorkingCalendar/CalDAVDiscovery.swift Sources/WorkingCalendar/CalDAVClient.swift Tools/VerifyCalDAVDiscovery.swift
SUBSCRIPTION_VERIFY_EXECUTABLE := $(BUILD_DIR)/VerifyICSSubscription
SUBSCRIPTION_VERIFY_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/CalendarSubscriptionDecoder.swift Sources/WorkingCalendar/CalendarSubscriptionHTTP.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Sources/WorkingCalendar/CalendarSubscriptionAnnotator.swift Tools/VerifyICSSubscription.swift
PROVIDER_BRIDGE_VERIFY_EXECUTABLE := $(BUILD_DIR)/VerifyProviderICSBridges
PROVIDER_BRIDGE_VERIFY_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Sources/WorkingCalendar/GoogleCalendarClient.swift Sources/WorkingCalendar/MicrosoftGraphCalendarClient.swift Tools/VerifyProviderICSBridges.swift
PROVIDER_WRITE_VERIFY_EXECUTABLE := $(BUILD_DIR)/VerifyProviderWritePayloads
PROVIDER_WRITE_VERIFY_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Sources/WorkingCalendar/CalDAVDiscovery.swift Sources/WorkingCalendar/CalDAVClient.swift Sources/WorkingCalendar/GoogleCalendarClient.swift Sources/WorkingCalendar/MicrosoftGraphCalendarClient.swift Tools/VerifyProviderWritePayloads.swift
PROVIDER_OUTBOX_VERIFY_EXECUTABLE := $(BUILD_DIR)/VerifyProviderOutbox
PROVIDER_OUTBOX_VERIFY_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Tools/VerifyProviderOutbox.swift
OAUTH_VERIFY_EXECUTABLE := $(BUILD_DIR)/VerifyOAuthDeviceFlow
OAUTH_VERIFY_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Tools/VerifyOAuthDeviceFlow.swift
PROVIDER_SYNC_RECOVERY_VERIFY_EXECUTABLE := $(BUILD_DIR)/VerifyProviderSyncRecovery
PROVIDER_SYNC_RECOVERY_VERIFY_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Sources/WorkingCalendar/ProviderICSObjectSyncer.swift Sources/WorkingCalendar/CalDAVDiscovery.swift Sources/WorkingCalendar/CalDAVClient.swift Sources/WorkingCalendar/GoogleCalendarClient.swift Sources/WorkingCalendar/MicrosoftGraphCalendarClient.swift Tools/VerifyProviderSyncRecovery.swift
...
LIVE_PROVIDER_SMOKE_SOURCES := Sources/WorkingCalendar/Models.swift Sources/WorkingCalendar/MeetingLinkExtractor.swift Sources/WorkingCalendar/CalendarURLNormalizer.swift Sources/WorkingCalendar/OAuthDeviceFlowClient.swift $(OAUTH_GENERATED_SOURCE) Sources/WorkingCalendar/ProviderRetryAfter.swift Sources/WorkingCalendar/ProviderDiagnostics.swift Sources/WorkingCalendar/LiveProviderSmokeContract.swift Sources/WorkingCalendar/CalendarProviderStore.swift Sources/WorkingCalendar/LocalCalendarStore.swift Sources/WorkingCalendar/LocalCalendarICSCodec.swift Sources/WorkingCalendar/CalendarSubscriptionDecoder.swift Sources/WorkingCalendar/CalendarSubscriptionHTTP.swift Sources/WorkingCalendar/CalDAVDiscovery.swift Sources/WorkingCalendar/CalDAVClient.swift Sources/WorkingCalendar/GoogleCalendarClient.swift Sources/WorkingCalendar/MicrosoftGraphCalendarClient.swift Tools/LiveProviderSmoke.swift
...
$(OAUTH_GENERATED_SOURCE): Tools/GenerateOAuthClientConfiguration.swift Makefile
	swift Tools/GenerateOAuthClientConfiguration.swift "$(OAUTH_GENERATED_SOURCE)" "$(GOOGLE_OAUTH_CLIENT_JSON)"
